...
export data=/home/boren/Code/kaldi/egs/librispeech/s5/data
export data=corpus/librispeech

### path to download data
data_download_path=/home/boren/data/librispeech/
